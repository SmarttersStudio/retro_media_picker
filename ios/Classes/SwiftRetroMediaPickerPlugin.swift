...
public class SwiftRetroMediaPickerPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "retro_media_picker", binaryMessenger: registrar.messenger())
    let instance = SwiftRetroMediaPickerPlugin()
